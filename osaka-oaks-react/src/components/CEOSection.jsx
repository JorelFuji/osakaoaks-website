        ...
        >
          <div className="aspect-square bg-gradient-radial from-navy-light via-navy to-navy border-2 border-gold flex flex-col items-center justify-center gap-4 mb-5">
            <motion.div
              ...
              className="w-32 h-32 border-[1.5px] border-gold/50 rounded-full flex items-center justify-center"
            >
            ...
            >
              {naicsCodes.map((code, index) => (
                <motion.span
                  ...
                  className="font-mono text-sm font-semibold text-navy bg-white border border-navy/20 px-3.5 py-2 tracking-tight cursor-default"
                >
                  {code}
                </motion.span>
              ))}
